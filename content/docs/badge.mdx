...
<Card className="items-center justify-center min-h-[350px] bg-background shadow-none p-6">
    <div className="flex flex-col gap-6 items-center">
        <div className="flex flex-col gap-2 items-center">
            <span className="text-sm text-muted-foreground">Standard Variants</span>
        ...
        <div className="flex flex-col gap-2 items-center">
            <span className="text-sm text-muted-foreground">Color Variants</span>
            <div className="flex flex-wrap gap-2 justify-center">
...
<div className="w-full flex justify-end">
    <OpenInV0Button url="https://my-component-library-woad.vercel.app/r/badge.json" />
</div>

<Tabs groupId='package-manager' persist items={['npm', 'pnpm', 'yarn', 'bun']} label='Install the badge'>

    ```bash tab="npm"
    npx shadcn@latest add https://my-component-library-woad.vercel.app/r/badge
    ```

    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/badge
    ```

    ```bash tab="yarn"
    yarn dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/badge
    ```

    ```bash tab="bun"
    bunx --bun shadcn@latest add https://my-component-library-woad.vercel.app/r/badge
    ```
</Tabs>
