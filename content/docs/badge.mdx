...
Badges can act as links and display an arrow icon when hovered.

<Card className="items-center justify-center min-h-[150px] bg-background shadow-none p-4">
    <div className="flex flex-wrap gap-2">
        <Badge href="#">Internal Link</Badge>
        <Badge href="https://example.com" external>External Link</Badge>
    </div>
</Card>