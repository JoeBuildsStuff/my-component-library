...
<Tabs groupId='package-manager' persist items={['npm', 'pnpm', 'yarn', 'bun']} label='Install the registry explorer'>
    ...
    ```bash tab="npm"
    npx shadcn@latest add https://my-component-library-woad.vercel.app/r/registry-explorer.json
    ```

    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/registry-explorer.json
    ```

    ```bash tab="yarn"
    yarn dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/registry-explorer.json
    ```

    ```bash tab="bun"
    bunx --bun shadcn@latest add https://my-component-library-woad.vercel.app/r/registry-explorer.json
    ```
</Tabs>
