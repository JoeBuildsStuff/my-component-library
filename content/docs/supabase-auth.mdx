...
<Tabs groupId='package-manager' persist items={['npm', 'pnpm', 'yarn', 'bun']} label='Install the supabase auth system'>
    ...
    ```bash tab="npm"
    npx shadcn@latest add https://my-component-library-woad.vercel.app/r/supabase-auth
    ```

    ```bash tab="pnpm"
    pnpm dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/supabase-auth
    ```

    ```bash tab="yarn"
    yarn dlx shadcn@latest add https://my-component-library-woad.vercel.app/r/supabase-auth
    ```

    ```bash tab="bun"
    bunx --bun shadcn@latest add https://my-component-library-woad.vercel.app/r/supabase-auth
    ```
</Tabs>
